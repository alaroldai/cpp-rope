...
# CMake file originaly from https://github.com/tokuhirom/tora
#
...
set(ICU_LIBS icuuc icuio icutu iculx icule icui18n icudata)
...
if(ICU_INCLUDE_DIR AND ICU_LIBRARY)
  ...
  # Look for the ICU internationalization libraries
    foreach(ICULIB ${ICU_LIBS})
        find_library(
            ICU_${ICULIB}
            NAMES ${ICULIB}
            DOC "Libraries to link against for ICU IO")
        if(ICU_${ICULIB})
            list(APPEND ICU_LIBRARIES ${ICU_${ICULIB}})
        else(ICU_${ICULIB})
            message(FATAL_ERROR "Could not find library for ${ICULIB}")
        endif(ICU_${ICULIB})
    endforeach(ICULIB)
